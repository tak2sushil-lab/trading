# research_full_suite_regime.py — Aug 5 2026
#
...
# symbol systematic sample of FULL_UNIVERSE, 2yr window (per standing directive).
#
...
def main():
    ...
    res.to_csv('/Users/sushil/trading/research_full_suite_regime_results.csv', index=False)
    ...
    print("\nFull results -> research_full_suite_regime_results.csv")
