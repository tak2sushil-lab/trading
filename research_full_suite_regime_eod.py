...
MAX_HOLD = 1   # Aug 5 2026 -- test: does the edge survive the live EOD-close constraint?
...
def main():
    ...
    res.to_csv('/Users/sushil/trading/research_full_suite_regime_eod_results.csv', index=False)
    ...
    print("\nFull results -> research_full_suite_regime_eod_results.csv")
